...
const Bookings = () => {
  ...
  const columns: TableColumn<Booking>[] = [
...

    {
      ...
      render: (booking) => (
        <div>
          <p className="font-medium text-slate-800">{booking.venueName}</p>

          <p className="mt-1 text-xs text-slate-400">{booking.city}</p>
        </div>
      ),
    },
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          // className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 active:scale-[0.98] cursor-pointer"
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-900 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-800 cursor-pointer"
        >
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Search booking, user, venue..."
          ...
          <div className="relative">
            ...
            <select
              ...
              className="h-11 min-w-42.5 appearance-none rounded-xl border border-slate-200 bg-slate-50 pl-9 pr-10 text-sm font-medium text-slate-700 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-100"
            >
          ...
          <div className="relative">
            <select
              ...
              className="h-11 min-w-42.5 appearance-none rounded-xl border border-slate-200 bg-slate-50 px-4 pr-10 text-sm font-medium text-slate-700 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-100"
            >
